...
class Controller(): 
     ...
     def edit(self):
          ...
          for component in self.components: 
               if component.mouse2start < 10: 
                    component.start_pos = self.mouse_position

               if component.mouse2end < 10: 
                    component.end_pos = self.mouse_position
                    
               component.update_line() 
     ...
     def handle_mouse_event (self,event,event_type):
          ...
          if self.current_mouse_event == "<B1-Motion>": 
               print(self.creating_component)
               print(self.selected_component)
               if self.creating_component == True: 
          ...
          # do all of the component calls here 
