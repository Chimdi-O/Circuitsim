...
class Controller(): 
     ...
     def create_component(self,component_features): 
        ...
        if file_path:
            with open(file_path , "r") as file: 
                 ...
                 for component_data in circuit_data: 
                      ...
                      self.type_selected = component_type_decoder[component_data[0]]
                      print(self.type_selected)
                      self.create_component(component_data[2:])
                      self.selected_component.move_line(component_data[1][0],component_data[1][1],component_data[1][2],component_data[1][3])
...
stop_button = tk.Button(text="stop",bg="grey")
stop_button.place(relheight=0.05)
whatprogramdoin = tk.Label(stop_button_frame, text="Noting!")
